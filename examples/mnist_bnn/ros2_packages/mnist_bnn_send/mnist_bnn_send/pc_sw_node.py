...
from forest_mnist_bnn_interface.msg import FpgaOut
from forest_mnist_bnn_interface.msg import FpgaIn
...
class PcSwNode(Node):
    ...
    def __init__(self):
        ...
        json_file = open('/home/danielpi/Desktop/work/case_studies/mnist_cnn/scripts/larq/architecture.json','r')
        loaded_model_json = json_file.read()
        json_file.close()
        self.model = model_from_json(loaded_model_json)
        self.model.load_weights("/home/danielpi/Desktop/work/case_studies/mnist_cnn/scripts/larq/binary_model.h5")
